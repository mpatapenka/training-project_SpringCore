...
public class EventTest {
	...
	public void initEvent() {
		event = new Event();
		event.setBasePrice(new BigDecimal(1.1));
		event.setName("aaa");
	...
	public void testAddRemoveAuditoriums() {
		...
		event.assignAuditorium(time, new Auditorium("", 1, "1"));
	...
	public void testAddRemoveAuditoriumsWithAirDates() {
		...
		event.addAirDateTime(time, new Auditorium("", 1, "1"));
	...
	public void testNotAddAuditoriumWithoutCorrectDate() {
		...
		boolean result = event.assignAuditorium(time, new Auditorium("", 1, "1"));
